...
# ----------------------------------------------------------------------
# Ensure the audio directory exists **before** mounting it
# ----------------------------------------------------------------------
...
# Static mounts
# ----------------------------------------------------------------------
# 1️⃣ Audio files (served at /audio)
app.mount("/audio", StaticFiles(directory="audio_files"), name="audio")

# ----------------------------------------------------------------------
# CORS middleware – remember to allow the Render domain as well
# ----------------------------------------------------------------------
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
...
# ----------------------------------------------------------------------
# Optional health‑check endpoint (does NOT sit on "/")
# ----------------------------------------------------------------------
@app.get("/health")
async def health():
...
# ----------------------------------------------------------------------
# Face‑tracking related endpoints
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
# Mount the React front‑end **after** all API routes
# ----------------------------------------------------------------------
app.mount(
    "/",                                 # root URL
...
# ----------------------------------------------------------------------
# Entry point – Render injects $PORT, fall back to 8000 for local dev
# ----------------------------------------------------------------------
